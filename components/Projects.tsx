...
export default function Projects({ config }: { config: any }) {
  ...
  const workSamples = config?.workSamples || []

  return (
    <section id="projects" className="section-padding bg-gradient-to-br from-blue-50 to-teal-50 dark:from-gray-800 dark:to-gray-900 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          {workSamples.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
              {workSamples.map((sample: any, index: number) => (
